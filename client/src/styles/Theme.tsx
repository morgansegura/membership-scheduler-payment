const dark = {
  // colors: {
  //   primary: style.colors.rose500,
  //   secondary: style.colors.yellow500,
  //   panel: {
  //     0: style.colors.gray900,
  //     5: style.colors.gray900,
  //     10: style.colors.gray800,
  //     20: style.colors.gray700,
  //     30: style.colors.gray600,
  //     40: style.colors.gray500,
  //     50: style.colors.gray400,
  //     60: style.colors.gray300,
  //     70: style.colors.gray200,
  //     80: style.colors.gray100,
  //     90: style.colors.gray50,
  //     100: style.colors.white,
  //   },
  // },
  // menu: {
  //   bgcolor: darken(0.03, style.colors.gray600),
  //   bordercolor: rgba(style.colors.gray800, 0.3),
  // },
  // body: {
  ...
  // },
  // form: {
  //   bgcolor: darken(0.03, style.colors.gray800),
  //   label: style.colors.slate300,
  //   border: `1px solid transparent`,
  //   boxshadow: ``,
  // },
  // input: {
  //   bgcolor: style.colors.gray900,
  //   bgcolorFocus: style.colors.gray900,
  //   bgcolorError: style.colors.gray900,
  //   border: `1px solid ${rgba(style.colors.gray700, 0.7)}`,
  //   borderFocus: `1px solid ${rgba(style.colors.gray600, 0.7)}`,
  ...
  //   outlineColor: rgba(style.colors.gray900, 0.4),
  // },
  // button: {
...
const light = {
  ...
  //     1: style.colors.black,
  //     5: style.colors.slate50,
  //     10: style.colors.slate100,
  //     20: style.colors.slate200,
  //     30: style.colors.slate300,
  //     40: style.colors.slate400,
  //     50: style.colors.slate500,
  //     60: style.colors.slate600,
  //     70: style.colors.slate700,
  //     80: style.colors.slate800,
  //     90: style.colors.slate900,
  //   },
  // },
  // body: {
  ...
  // menu: {
  //   bgcolor: style.colors.white,
  //   bordercolor: rgba(style.colors.gray200, 0.75),
  // },
  // form: {
  //   bgcolor: style.colors.white,
